...
```
Task(
  prompt="Read /Users/davidsong/Desktop/replova/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/davidsong/Desktop/replova/.claude/get-shit-done/templates/SECURITY.md`
