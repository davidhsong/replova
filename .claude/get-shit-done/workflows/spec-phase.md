...
```bash
INIT=$(node "/Users/davidsong/Desktop/replova/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/davidsong/Desktop/replova/.claude/get-shit-done/templates/spec.md.
