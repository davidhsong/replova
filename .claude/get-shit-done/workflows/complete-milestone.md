...
```bash
node "/Users/davidsong/Desktop/replova/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/davidsong/Desktop/replova/.claude/get-shit-done/templates/retrospective.md`.
