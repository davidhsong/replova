...
- **Global scope**: `/Users/davidsong/Desktop/replova/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/davidsong/Desktop/replova/.claude/notes/`)
...
2. Glob `/Users/davidsong/Desktop/replova/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/davidsong/Desktop/replova/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/davidsong/Desktop/replova/.claude/notes/` — works in any directory
