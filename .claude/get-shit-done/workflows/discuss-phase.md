...
<required_reading>
@/Users/davidsong/Desktop/replova/.claude/get-shit-done/references/domain-probes.md
@/Users/davidsong/Desktop/replova/.claude/get-shit-done/references/gate-prompts.md
@/Users/davidsong/Desktop/replova/.claude/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @/Users/davidsong/Desktop/replova/.claude/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
PROFILE_CONTENT=$(cat "/Users/davidsong/Desktop/replova/.claude/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a Task() in parallel:
   ...
   Task(
     prompt="First, read @/Users/davidsong/Desktop/replova/.claude/agents/gsd-advisor-researcher.md for your role and instructions.
...
**Full step-by-step instructions:** @/Users/davidsong/Desktop/replova/.claude/get-shit-done/workflows/discuss-phase-power.md
