...
<reference>
@/Users/davidsong/Desktop/replova/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/davidsong/Desktop/replova/.claude/get-shit-done/references/user-profiling.md` to load:
