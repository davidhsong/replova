...
function getResponse(input: string, ctx: ChatContext): BotResponse {
  ...
  if (m(q, 'starter') && m(q, 'plan', 'include', 'feature', 'what', 'get', 'have', 'offer')) {
    return {
      text: `Starter ($39/mo): 1 location, AI reply drafts (3 tones), urgent review alerts, weekly digest, and review request campaigns. Competitor tracking starts on Growth.${ctx.plan === 'starter' ? ' This is your current plan.' : ''}`,
      link: { label: 'View Billing', href: '/dashboard/billing' },
    }
  }
